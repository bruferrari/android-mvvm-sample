 ...
 */
fun <A, B> zipLiveData(a: MutableLiveData<A>, b: MutableLiveData<B>): MutableLiveData<Pair<A, B>> {
 ...
 * @author Mitchell Skaggs
 */
fun <A, B> MutableLiveData<A>.zip(b: MutableLiveData<B>): MutableLiveData<Pair<A, B>> = zipLiveData(this, b)
